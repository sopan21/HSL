...
if (isset($_POST['post'])) {
   ...
   $are_pincode = $_POST['are_pincode'];
   $are_pincode = filter_var($are_pincode, FILTER_SANITIZE_STRING);
   $offer = $_POST['offer'];
   ...
   if ($image_01_size > 2000000) {
      ...
      $insert_property = $conn->prepare("INSERT INTO `property`(id, user_id, property_name, address, are_pincode, price, type, offer, status, furnished, bhk, deposite, bedroom, bathroom, balcony, carpet, age, total_floors, room_floor, loan, lift, security_guard, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
      $insert_property->execute([$id, $user_id, $property_name, $address, $are_pincode, $price, $type, $offer, $status, $furnished, $bhk, $deposite, $bedroom, $bathroom, $balcony, $carpet, $age, $total_floors, $room_floor, $loan, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
   ...
   <section class="property-form">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
         ...
         <div class="flex">
            ...
            <div class="box">
               <p>Are Pincode<span>*</span></p>
               <input type="text" name="are_pincode" required maxlength="10" placeholder="enter property are_pincode"
                  class="input">
            </div>
            <div class="box">
            ...
            <div class="box">
               ...
               <select name="bhk" required class="input">
                  ...
                  <option value="1">Ro-House</option>
