...
<header class="header">
   ...
   <nav class="navbar nav-1">
      <section class="flex">
         <a href="home.php" class="logo"><i class="fas fa-house"></i>HSL</a>

         <ul>
            <li><a href="post_property.php" style="border-radius: 10px;">Post Property<i class="fas fa-paper-plane"></i></a></li>
         </ul>
      </section>
   </nav>
