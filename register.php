...
<section class="form-container">
   <form action="" method="post" onsubmit="return validateForm()">
      ...
      <input type="password" name="pass" id="pass" required minlength="6" maxlength="20" placeholder="enter your password" class="box">
      <input type="password" name="c_pass" id="c_pass" required minlength="6" maxlength="20" placeholder="confirm your password" class="box">
      <p id="passwordError" style="display:none; color:red;">Password should be at least 6 characters long and contain at least 1 special symbol, 1 number, and 1 character.</p>
